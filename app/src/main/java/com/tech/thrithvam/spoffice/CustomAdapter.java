    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (calledFrom) {
            ...
            case Common.REQUISITIONDETAILLIST:
                ...
                holder.amount.setText(adapterContext.getResources().getString(R.string.rupees,String.format(Locale.US,"%.2f",Double.parseDouble(filteredObjects.get(position)[4]))));
